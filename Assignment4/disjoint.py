...
if __name__ == '__main__':
    ...
    # union(5,6)
    print('The disjoint set is' + str(disjoint_set.get()))
    disjoint_set.union(5, 6)
    print('The disjoint set after union(5,6) is ' + str(disjoint_set.get()))
    # union(7,8)
    disjoint_set.union(7, 8)
    print('The disjoint set after union(7,8) is ' + str(disjoint_set.get()))
    # union(5,7)
    disjoint_set.union(5, 7)
    print('The disjoint set after union(5,7) is ' + str(disjoint_set.get()))

    print('Finding element non-recursively with path compressions...')
    print(str(disjoint_set.find(7)))
